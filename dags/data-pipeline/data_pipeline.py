...
GLUE_ROLE_ARN='AWSGlueServiceRoleDefault'
...
dag=DAG(dag_name, default_args=default_args, dagrun_timeout=timedelta(hours=2), schedule_interval='0 3 * * *')

#S3 Data Availability Wait Sensor
...
#Glue Crawler Config
glue_crawler_config={
    "Name": "NycTaxiDataCrawler",
    "Role": GLUE_ROLE_ARN,
    "DatabaseName": 'default',
    "Targets": {"S3Targets": [{"Path": f"{S3_BUCKET_NAME}/data/raw/green"}]},
}

glue_crawler=GlueCrawlerOperator(task_id='glue_crawler', config=glue_crawler_config, dag=dag)
...
glue_job = GlueJobOperator(
    ...
    create_job_kwargs={"GlueVersion": "4.0", "NumberOfWorkers": 2, "WorkerType": "G.1X", "MaxRetries": 3},
...
#Checks before terminating EMR cluster
